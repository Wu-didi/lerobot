...
# resume training
lerobot-train \
    --config_path=/home/wudi/code/lerobot_0.5.1/lerobot/outputs/pi05_training_expert_only/checkpoints/last/pretrained_model/train_config.json \
    --resume=true
...
#     --policy.repo_id=zsx/pi05 \
#     --policy.push_to_hub=false \
#     --policy.pretrained_path=/media/wudi/f/wudi/lerobot/pi05_training_dagger/012000/pretrained_model \
#     --policy.compile_model=false \
#     --policy.gradient_checkpointing=true \
#     --policy.dtype=bfloat16 \
#     --wandb.enable=false \
